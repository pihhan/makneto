...
a speciální bod - supernode \cite{skypeprotocol}. Supernode je významný bod,
...
Google Talk je slu¾ba provozovaná firmou Google, je integrovaná spolu s úètem
...
knihovna pochází z doby pøed vydáním XEP-166\cite{XmppJingle} a není
...
\section{Standartizované protokoly}
...
hlavièkou. Dùle¾itou polo¾kou je sedmibitový typ pøená¹ených dat - payload type (PT), jeho¾ hodnotu urèuje RFC 3551. Následuje sestnáctibitový èítaè, který 
...
Tuto situaci øe¹í obecné roz¹íøení Jingle \cite{jingle}. Toto roz¹íøení 
...
kanálu\cite{jingleTransport} a výbìr kodeku pro pøená¹ená data\cite{jingleRtp}
...
autorù \cite{gstreamer} si vypùjèuje to nejlep¹í z OGI media pipeline a Microsoft DirectShow.
...
Objekty frameworku lze rozdìlit do nìkolika skupin. Asi nejdùle¾itìj¹í jsou
zdroje dat a jejich výstupy, zvané sink (doslovnì pøelo¾eno umyvadlo). Ka¾dý 
...
Aplikace Makneto je velmi zajímavý program, i kdy¾ na nìkterých místech je
je¹tì nutné pracovat a nìkteré vlastnosti vypilovat. Byla odstranìna chyba 
